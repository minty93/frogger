...
var height = document.getElementById("canvas").height;
 for (var h = 0; h < 8; h++) {
   this.add(new Frogger.LogR({
     game: this,
     pos: [90*h*5, 110*(height/700)]
   }));
 }
 for (var z = 0; z < 8; z++) {
   this.add(new Frogger.LogL({
     game: this,
     pos: [90*z*7, 55*(height/700)]
   }));
 }
 for (var l = 0; l < 10; l++) {
   this.add(new Frogger.LogL({
     game: this,
     pos: [90*l*1/3*7, 168*(height/700)]
   }));
 }
};
